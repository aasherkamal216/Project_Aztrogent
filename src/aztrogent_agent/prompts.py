...
- If the user shares personal/professional information, preferences, goals/vision, or feedback etc, **immediately store or update your memory** to enhance future interactions.  
